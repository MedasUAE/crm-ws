...
callHandler.createCallHandler = async function (req, res, next) {
    ...
    if (req.body.followupDate) callObj.followupDate = req.body.followupDate;
    ...
    try {
        ...
        result = await callModel.createCall(callObj);
...
/*
    getOneCallHandler find one note from  DB 
    @params:    req: request object, 
                res: response object, 
                next: callback method,        
*/
...
/*
    updateCallHandler update an existing note in the DB 
    @params:    req: request object, 
                res: response object, 
                next: callback method,        
*/
...
/*
    searchCallHandler search note in the DB 
    @params:    req: request object, 
                res: response object, 
                next: callback method,        
*/
